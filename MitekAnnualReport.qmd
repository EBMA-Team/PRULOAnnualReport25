...
```{epoxy}
#| label: Failure-Report-Rep3B-Proc1
...
```{r}
#| label: tbl-Rep3RC4
#| tbl-cap: "Summary of PRULO Report 3 (Rotator Cuff) Cases - Adverse Events"
...
```{epoxy}
#| label: Reoperations-Report-Rep3B-Proc1
...
```{epoxy}
#| label: Failure-Report-Rep3B-Proc2
...
```{r}
#| label: tbl-Rep3BT4
#| tbl-cap: "Summary of PRULO Report 3 (Biceps Tenodesis) Cases - Adverse Events"
...
```{epoxy}
#| label:  Reoperations-Report-Rep3B-Proc2
...
```{epoxy}
#| label:  Failure-Report-Rep4B-Proc1
...
Complications and adverse events are summarised below. Individual reoperation data can be accessed in [Attachment 1](https://docs.google.com/spreadsheets/d/https://docs.google.com/spreadsheets/d/1ESVvSKAv8ma11kri9pby6OEU9Gk5Z3UnF6XwjXBTcTg/edit#gid=0).
...
#| tbl-cap: "Summary of PRULO Report 4 (Rotator Cuff) Cases - Adverse Events"
...
```{epoxy}
#| label:  Reoperations-Report-Rep4B-Proc1
...
```{epoxy}
#| label:  Failure-Report-Rep4B-Proc2
...
#| tbl-cap: "Summary of PRULO Report 4 (Biceps Tenodesis) Cases - Adverse Events"
...
```{r}
#| label: Reoperations-Report-Rep4A-Proc2
...
```{epoxy}
#| label:  Reoperations-Report-Rep4B-Proc2
...
```{epoxy}
#| label:  Failure-Report-Rep5B-Proc1
...
#| tbl-cap: "Summary of PRULO Report 5 (Rotator Cuff) Cases - Adverse Events"
...
```{epoxy}
#| label:  Reoperations-Report-Rep5B-Proc1
...
```{epoxy}
#| label:  Failure-Report-Rep5B-Proc2
...
#| tbl-cap: "Summary of PRULO Report 5 (Biceps Tenodesis) Cases - Adverse Events"
...
```{epoxy}
#| label:  Reoperations-Report-Rep5B-Proc2
...
```{epoxy}
#| label: Failure-Report-Rep6B-Proc1
...
Complications and adverse events are summarised below. Individual reoperation data can be accessed in [Attachment 1](https://docs.google.com/spreadsheets/d/https://docs.google.com/spreadsheets/d/1ESVvSKAv8ma11kri9pby6OEU9Gk5Z3UnF6XwjXBTcTg/edit).
...
#| tbl-cap: "Summary of PRULO Report 6 (All) Cases - Adverse Events"
...
```{epoxy}
#| label: Reoperations-Report-Rep6B-Proc1
...
```{epoxy }
#| label: Failure-Report-Rep6B-Proc2
...
#| tbl-cap: "Summary of PRULO Report 6 (Bankart Repair) Cases - Adverse Events"
...
```{epoxy}
#| label: Reoperations-Report-Rep6BRB-Proc2
...
```{epoxy}
#| label:  Failure-Report-Rep7B-Proc1
...
#| tbl-cap: "Summary of PRULO Report 7 (All) Cases - Adverse Events"
...
```{epoxy}
#| label:  Reoperations-Report-Rep7B-Proc1
...
```{epoxy}
#| label:  Failure-Report-Rep7B-Proc2
...
#| tbl-cap: "Summary of PRULO Report 7 (Bankart Repair) Cases - Adverse Events"
...
```{epoxy}
#| label: Reoperations-Report-Rep7BRB-Proc2
...
```{epoxy}
#| label: Failure-Report-Rep10B-Proc1 
...
#| tbl-cap: "Summary of PRULO Report 10 (All) Cases - Adverse Events"
...
```{r}
#| label: Reoperations-Report-Rep10A-Proc1
...
```{epoxy}
#| label: Reoperations-Report-Rep10B-Proc1
...
```{epoxy}
#| label: Failure-Report-Rep11B-Proc1
...
#| tbl-cap: "Summary of PRULO Report 11 (Rotator Cuff) Cases - Adverse Events"
...
```{r}
#| label: Reoperations-Report-Rep11B-Proc1
...
SelectRep <- bind_rows(
  ...
  tidyr::pivot_wider(
    ...
    values_fill = 0,
    values_fn = max  # This will take the maximum value when there are duplicates
  )
