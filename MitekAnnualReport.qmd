...
flextable::set_flextable_defaults(
  ...
  # Post-processing for header font size
  post_process_all = function(x) {
    x |> 
...
message_text <- if_else(
  nrow(ProductUsage2 |> filter(is.na(Description)) |> arrange(ImplantCodes)) < 1,
...
if (!has_complications) {
  ...
  epoxy_html("No intraoperative complications observed.")
} else {
