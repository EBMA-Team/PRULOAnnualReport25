...
if (nrow(SelectRep6BRReop) == 0) {
  ...
  epoxy::epoxy_html('Reoperations are available within the <a href="{{SheetIDs$AuditReport}}">external file</a> for further review')
}
...
SelectRepAll1 <- SelectRepAll |> select(-TreatmentID)
