...
SnapshotComb <- SnapshotRC |> dplyr::select(-(c(ExternalStudyTag,Email,Phone))) |> # Combine 'SnapshotGH' and 'SnapshotGen' tables with 'SnapshotRC' table by removing the specified columns.
...
```{r}
#| label:  Failure-Report-Rep1B-Proc1-display

{ifelse(nrow(FailuresRep1RC) == 0,
        "There are no failures or revisions to report.",
...
```{r}
#| label:  Reoperations-Report-Rep1B-Proc1-display
...
```{r}
#| label:  Failure-Report-Rep1B-Proc2-display
