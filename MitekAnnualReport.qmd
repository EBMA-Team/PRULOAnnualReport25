...
if (nrow(SelectRep1RCReop) == 0) {
  ...
  epoxy::epoxy_html('Reoperations were written to an <a href="{{SheetIDs$AuditReport}}">external file</a> for further review')
}
...
if (nrow(SelectRep1BTReop) == 0) {
  ...
  epoxy::epoxy_html('Reoperations were appended to an <a href="{{SheetIDs$AuditReport}}">external file</a> for further review')
}
...
if (nrow(SelectRep6BRReop) == 0) {
  epoxy::epoxy_html("There are no reoperations to report specific to this indication.")
} else {
  epoxy::epoxy_html('Reoperations appear in the <a href="{{SheetIDs$AuditReport}}">external file</a> for further review')
}
